...
@section('title', __('rb28dett_roles::general.edit_role'))
@section('subtitle', __('rb28dett_roles::general.edit_desc', ['id' => $role->id, 'time_ago' => $role->created_at->diffForHumans()]))
@section('breadcrumb')
			...
			<div class="uk-width-1-1@s uk-width-3-5@l uk-width-1-3@xl">
				<div class="uk-card uk-card-default">
					<div class="uk-card-header">
						@lang('rb28dett_roles::general.edit_role', ['id' => $role->id])
					</div>
					<div class="uk-card-body">
						<form method="POST" action="{{ route('rb28dett::roles.update', ['role' => $role]) }}" class="uk-form-stacked">
							{{ csrf_field() }}
							{{ method_field('PATCH') }}
							<fieldset class="uk-fieldset">
								<div class="uk-margin">
									...
									<input value="{{ old('name', $role->name) }}" name="name" class="uk-input" type="text" placeholder="@lang('rb28dett_roles::general.name')">
								</div>
								<div class="uk-margin">
									<label class="uk-form-label">
										@lang('rb28dett_roles::general.color') <span class="uk-text-danger">*</span>
									</label>
									<input value="{{ old('color', isset($role) ? $role->color : '') }}" name="color" class="uk-input" type="color" placeholder="@lang('rb28dett_roles::general.color')">
								</div>
								<div class="uk-margin">
									<label class="uk-form-label">
								...
								<div class="uk-margin">
									...
									<button type="submit" class="uk-button uk-button-primary uk-align-right">
										<span class="ion-forward"></span>&nbsp; @lang('rb28dett_roles::general.edit')
									</button>
								</div>
							</fieldset>
						</form>
