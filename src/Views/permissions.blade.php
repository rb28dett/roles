...
@section('title', __('rb28dett_roles::general.role_permissions'))
@section('subtitle', __('rb28dett_roles::general.permissions_desc', ['id' => $role->id, 'total' => $permissions->count()]))
@section('breadcrumb')
    <ul class="uk-breadcrumb">
        ...
        <li><span>@lang('rb28dett_roles::general.role_permissions')</span></li>
    </ul>
@endsection
@section('content')
            ...
            <div class="uk-width-1-1">
                <div class="uk-card uk-card-default">
                    <div class="uk-card-header">
                        @lang('rb28dett_roles::general.available_permissions')
                    </div>
                        ...
                        <form class="uk-form-stacked" method="POST">
                            ...
                            <fieldset class="uk-fieldset">
                                <div uk-grid>
                                   ...
                                   <div class="uk-margin">
                                       <a href="{{ route('rb28dett::roles.index') }}" class="uk-button uk-button-default"> @lang('rb28dett_roles::general.cancel')</a>
                                       <div class="uk-align-right">
                                           <button type="submit" class="uk-button uk-button-primary">
                                               <span class="ion-forward"></span>&nbsp; @lang('rb28dett_roles::general.submit')
                                           </button>
                                       </div>
                                   </div>
                               </fieldset>
